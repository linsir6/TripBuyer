package com.example.lin_sir_one.tripbuyer.leancloudchatkit.adapter;
...
import com.example.lin_sir_one.tripbuyer.leancloudchatkit.viewholder.LCIMChatItemAudioHolder;
import com.example.lin_sir_one.tripbuyer.leancloudchatkit.viewholder.LCIMChatItemHolder;
import com.example.lin_sir_one.tripbuyer.leancloudchatkit.viewholder.LCIMChatItemImageHolder;
import com.example.lin_sir_one.tripbuyer.leancloudchatkit.viewholder.LCIMChatItemLocationHolder;
import com.example.lin_sir_one.tripbuyer.leancloudchatkit.viewholder.LCIMChatItemTextHolder;
import com.example.lin_sir_one.tripbuyer.leancloudchatkit.viewholder.LCIMCommonViewHolder;
import com.example.lin_sir_one.tripbuyer.leancloudchatkit.viewholder.OrderHolder;
...
public class LCIMChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final int TYPE_1000 = 1000;
    private final int TYPE_1001 = 1001;
    ...
    public int getItemViewType(int position) {
        ...
        if (null != message && message instanceof AVIMTypedMessage) {
            ...
            Log.i("lin", "++++lin++++>   " + typedMessage.getContent());
            boolean isMe = fromMe(typedMessage);
            Log.i("lin", "++++lin++++> 33  " + typedMessage.getContent().split("\"")[3]);

            try {
                if (typedMessage.getContent().split("\"")[3].split("♂")[0].equals("~!@#$")) {
                    Log.i("lin", "---lin--->   正在生成订单");
                    return isMe ? 1000 : 1001;
                }
            } catch (Exception e) {
